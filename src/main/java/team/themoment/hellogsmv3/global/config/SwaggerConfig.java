...
@OpenAPIDefinition(
    info =
        @Info(title = "Hello, GSM 2025", description = "광주소프트웨어마이스터고등학교 입학지원 시스템", version = "v1"))
@Configuration
public class SwaggerConfig {
  ...
  public OperationCustomizer operationCustomizer() {
    return (operation, handlerMethod) -> {
      ...
      this.addResponseBodyWrapperSchemaExample(
          operation, CommonApiResponse.class.isAssignableFrom(returnType));
