...
public class KakaoOAuthProvider implements OAuthProvider {
  ...
  private KakaoTokenResDto exchangeCodeForToken(
    ...
    try {
      ...
      throw new ExpectedException(
          "Kakao OAuth 토큰 교환에 실패했습니다: " + e.getMessage(), HttpStatus.UNAUTHORIZED);
    }
  }
  ...
  private KakaoUserInfoResDto getUserInfo(String accessToken) {
    try {
      ...
      throw new ExpectedException(
          "Kakao 사용자 정보 조회에 실패했습니다: " + e.getMessage(), HttpStatus.UNAUTHORIZED);
    }
  }
