...
public class MemberController {
  ...
  public CommonApiResponse sendCode(
      @AuthRequest Long memberId, @RequestBody @Valid GenerateCodeReqDto reqDto) {
  ...
  public CommonApiResponse authCode(
      @AuthRequest Long memberId, @RequestBody @Valid AuthenticateCodeReqDto reqDto) {
  ...
  @ApiResponses(
      value = {
        ...
        @ApiResponse(
            responseCode = "204",
            description = "1차 전형 결과가 아직 발표되지 않았습니다.",
            content = @Content())
      })
  ...
  @ApiResponses(
      value = {
        ...
        @ApiResponse(
            responseCode = "204",
            description = "2차 전형 결과가 아직 발표되지 않았습니다.",
            content = @Content())
      })
