...
@Table(
    ...
    indexes = {
      @Index(
          name = "idx_applied_screening_and_real_oneseo_arrived_yn",
          columnList = "applied_screening, real_oneseo_arrived_yn"),
...
public class Oneseo {
  ...
  @NotNull @Embedded protected DesiredMajors desiredMajors;
  ...
  public void addWantedScreeningChangeHistory(
      WantedScreeningChangeHistory wantedScreeningChangeHistory) {
