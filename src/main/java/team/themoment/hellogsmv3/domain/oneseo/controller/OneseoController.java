...
public class OneseoController {
  ...
  public CommonApiResponse create(
      @RequestBody @Valid OneseoReqDto reqDto, @AuthRequest Long memberId) {
  ...
  public CommonApiResponse modifyByAdmin(
      @RequestBody @Valid OneseoReqDto reqDto, @PathVariable("memberId") Long memberId) {
  ...
  public CommonApiResponse modifyInterviewScore(
      @PathVariable Long memberId, @RequestBody @Valid InterviewScoreReqDto reqDto) {
  ...
  public SearchOneseosResDto search(
      ...
      @Schema(
              description = "합격, 불합격 여부",
              defaultValue = "ALL",
              allowableValues = {"ALL", "FIRST_PASS", "FINAL_PASS", "FALL"})
          @RequestParam(name = "testResultTag")
          String testResultParam,
      @Schema(
              description = "지원 전형",
              defaultValue = "GENERAL",
              allowableValues = {"GENERAL", "SPECIAL", "EXTRA"})
          @RequestParam(name = "screeningTag", required = false)
          String screeningParam,
      @Schema(
              description = "서류 제출 여부",
              defaultValue = "YES",
              allowableValues = {"YES", "NO"})
          @RequestParam(name = "isSubmitted", required = false)
          String isSubmittedParam,
    ...
    try {
      ...
      ScreeningCategory screeningCategory =
          (screeningParam != null) ? ScreeningCategory.valueOf(screeningParam) : null;
  ...
  public CommonApiResponse modifyEntranceIntention(
      @PathVariable Long memberId, @RequestBody @Valid EntranceIntentionReqDto reqDto) {
