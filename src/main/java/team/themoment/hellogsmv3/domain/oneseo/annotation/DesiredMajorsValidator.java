...
public class DesiredMajorsValidator
    implements ConstraintValidator<ValidDesiredMajors, OneseoReqDto> {

  @Override
  public boolean isValid(OneseoReqDto dto, ConstraintValidatorContext context) {

    boolean hasNullMajor =
        dto.firstDesiredMajor() == null
            || dto.secondDesiredMajor() == null
