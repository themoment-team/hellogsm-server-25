...
public class CustomOneseoRepositoryImpl implements CustomOneseoRepository {
  ...
  @Override
  public Optional<Oneseo> findByGuardianOrTeacherPhoneNumberAndSubmitCode(
      String phoneNumber, String submitCode) {
  ...
  @Override
  public Optional<Oneseo> findByGuardianOrTeacherPhoneNumberAndExaminationNumber(
      String phoneNumber, String examinationNumber) {
    return Optional.ofNullable(
        queryFactory
            .selectFrom(oneseo)
            .join(oneseo.oneseoPrivacyDetail, oneseoPrivacyDetail)
  ...
  public Page<SearchOneseoResDto> findAllByKeywordAndScreeningAndSubmissionStatusAndTestResult(
    ...
    BooleanBuilder builder =
        createBooleanBuilder(keyword, screeningTag, isSubmitted, testResultTag);
  ...
  public List<Oneseo> findAllByScreeningWithAllDetails(Screening screening) {
    boolean isExistAppliedScreening =
        queryFactory
                .selectOne()
                .from(oneseo)
    ...
    return queryFactory
        ...
        .join(oneseo.entranceTestResult, entranceTestResult)
        .fetchJoin()
        .join(entranceTestResult.entranceTestFactorsDetail, entranceTestFactorsDetail)
        .fetchJoin()
        .leftJoin(oneseo.middleSchoolAchievement, middleSchoolAchievement)
        .fetchJoin()
        .where(
            isExistAppliedScreening
