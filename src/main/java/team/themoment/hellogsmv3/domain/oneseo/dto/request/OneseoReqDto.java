...
public record OneseoReqDto(
    ...
    @Schema(
            description = "지원자 졸업상태",
            defaultValue = "CANDIDATE",
            allowableValues = {"CANDIDATE", "GED", "GRADUATE"})
        @NotNull
    ...
    @Schema(
            ...
            allowableValues = {"GENERAL", "SPECIAL", "EXTRA_VETERANS", "EXTRA_ADMISSION"})
        @NotNull
        Screening screening,
    ...
    @Schema(description = "학생 번호", defaultValue = "30508") @Pattern(regexp = "^\\d{5}$")
