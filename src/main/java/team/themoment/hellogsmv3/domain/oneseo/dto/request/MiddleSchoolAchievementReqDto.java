...
public record MiddleSchoolAchievementReqDto(
    ...
    @Schema(
            description = "1학년 2학기 일반교과 성취점수",
            nullable = true,
            defaultValue = "[4, 5, 3, 5, 4, 5, 3, 5, 2]")
        List<Integer> achievement1_2,
    @Schema(
            description = "2학년 1학기 일반교과 성취점수",
            nullable = true,
            defaultValue = "[4, 5, 3, 5, 4, 5, 3, 5, 2]")
        List<Integer> achievement2_1,
    @Schema(
            description = "2학년 2학기 일반교과 성취점수",
            nullable = true,
            defaultValue = "[5, 2, 5, 5, 4, 1, 5, 5, 0]")
        List<Integer> achievement2_2,
    @Schema(
            description = "3학년 1학기 일반교과 성취점수",
            nullable = true,
            defaultValue = "[3, 5, 3, 5, 1, 3, 5, 2, 0]")
    ...
    @Schema(
            description = "자유학기 or 학년제 시스템",
            nullable = true,
            defaultValue = "자유학년제",
            allowableValues = {"자유학기제", "자유학년제"})
        String liberalSystem,
    @Schema(
            description = "자유학기제 학기",
            nullable = true,
            defaultValue = "null",
            allowableValues = {"1-1", "1-2", "2-1", "2-2", "3-1", "3-2"})
        String freeSemester,
