...
public class CreateOneseoService {
  ...
  public FoundOneseoResDto execute(OneseoReqDto reqDto, Long memberId) {
    ...
    CalculatedScoreResDto calculatedScoreResDto =
        calculateMiddleSchoolAchievement(
            reqDto.graduationType(), reqDto.middleSchoolAchievement(), oneseo);
    ...
    return buildOneseoResDto(
        oneseo, oneseoPrivacyDetailResDto, middleSchoolAchievementResDto, calculatedScoreResDto);
  }

  private void sendOneseoApplyEvent(
      Member currentMember, Oneseo oneseo, OneseoPrivacyDetail oneseoPrivacyDetail) {
    OneseoApplyEvent oneseoApplyEvent =
        OneseoApplyEvent.builder()
  ...
  private MiddleSchoolAchievement buildMiddleSchoolAchievement(OneseoReqDto reqDto, Oneseo oneseo) {
    MiddleSchoolAchievement.MiddleSchoolAchievementBuilder builder =
        MiddleSchoolAchievement.builder();
    MiddleSchoolAchievementReqDto middleSchoolAchievement = reqDto.middleSchoolAchievement();
    // calcDto를 통해 성적복사 처리
    MiddleSchoolAchievementCalcDto calcDto =
        buildCalcDtoWithFillEmpty(reqDto.middleSchoolAchievement(), reqDto.graduationType());
