...
class QueryOneseoByIdServiceTest {
  ...
  @Mock private OneseoPrivacyDetailRepository oneseoPrivacyDetailRepository;

  @Mock private MiddleSchoolAchievementRepository middleSchoolAchievementRepository;

  @InjectMocks private QueryOneseoByIdService queryOneseoByIdService;
  ...
  class Describe_execute {
    ...
    class Context_with_existing_member_id {
      ...
      void setUp_it_returns_oneseo() {
        ...
        given(middleSchoolAchievementRepository.findByOneseo(oneseo))
            .willReturn(middleSchoolAchievement);
      }
      ...
      void it_returns_oneseo() {
        ...
        assertEquals(
            oneseo.getDesiredMajors().getFirstDesiredMajor(),
            desiredMajorsResDto.firstDesiredMajor());
        assertEquals(
            oneseo.getDesiredMajors().getSecondDesiredMajor(),
            desiredMajorsResDto.secondDesiredMajor());
        assertEquals(
            oneseo.getDesiredMajors().getThirdDesiredMajor(),
            desiredMajorsResDto.thirdDesiredMajor());
        ...
        assertEquals(
            oneseoPrivacyDetail.getGraduationType(), oneseoPrivacyDetailResDto.graduationType());
        assertEquals(
            oneseoPrivacyDetail.getGraduationDate(), oneseoPrivacyDetailResDto.graduationDate());
        assertEquals(oneseoPrivacyDetail.getAddress(), oneseoPrivacyDetailResDto.address());
        assertEquals(
            oneseoPrivacyDetail.getDetailAddress(), oneseoPrivacyDetailResDto.detailAddress());
        assertEquals(
            oneseoPrivacyDetail.getGuardianName(), oneseoPrivacyDetailResDto.guardianName());
        assertEquals(
            oneseoPrivacyDetail.getGuardianPhoneNumber(),
            oneseoPrivacyDetailResDto.guardianPhoneNumber());
        assertEquals(
            oneseoPrivacyDetail.getRelationshipWithGuardian(),
        ...
        assertEquals(
            oneseoPrivacyDetail.getSchoolAddress(), oneseoPrivacyDetailResDto.schoolAddress());
        assertEquals(
            oneseoPrivacyDetail.getSchoolTeacherName(),
            oneseoPrivacyDetailResDto.schoolTeacherName());
        assertEquals(
        ...
        assertEquals(
            oneseoPrivacyDetail.getStudentNumber(), oneseoPrivacyDetailResDto.studentNumber());

        MiddleSchoolAchievementResDto middleSchoolAchievementResDto =
            result.middleSchoolAchievement();
        assertEquals(
            middleSchoolAchievement.getAchievement1_2(),
            middleSchoolAchievementResDto.achievement1_2());
        assertEquals(
            middleSchoolAchievement.getAchievement2_1(),
            middleSchoolAchievementResDto.achievement2_1());
        assertEquals(
            middleSchoolAchievement.getAchievement2_2(),
            middleSchoolAchievementResDto.achievement2_2());
        assertEquals(
            middleSchoolAchievement.getAchievement3_1(),
            middleSchoolAchievementResDto.achievement3_1());
        assertEquals(
            middleSchoolAchievement.getAchievement3_2(),
            middleSchoolAchievementResDto.achievement3_2());
        assertEquals(
            middleSchoolAchievement.getGeneralSubjects(),
            middleSchoolAchievementResDto.generalSubjects());
        assertEquals(
            middleSchoolAchievement.getNewSubjects(), middleSchoolAchievementResDto.newSubjects());
        assertEquals(
            middleSchoolAchievement.getArtsPhysicalAchievement(),
            middleSchoolAchievementResDto.artsPhysicalAchievement());
        assertEquals(
            middleSchoolAchievement.getArtsPhysicalSubjects(),
            middleSchoolAchievementResDto.artsPhysicalSubjects());
        assertEquals(
            middleSchoolAchievement.getAbsentDays(), middleSchoolAchievementResDto.absentDays());
        assertEquals(
            middleSchoolAchievement.getAttendanceDays(),
            middleSchoolAchievementResDto.attendanceDays());
        assertEquals(
            middleSchoolAchievement.getVolunteerTime(),
            middleSchoolAchievementResDto.volunteerTime());
        assertEquals(
            middleSchoolAchievement.getLiberalSystem(),
            middleSchoolAchievementResDto.liberalSystem());
        assertEquals(
            middleSchoolAchievement.getFreeSemester(),
            middleSchoolAchievementResDto.freeSemester());
        assertEquals(
            middleSchoolAchievement.getGedAvgScore(), middleSchoolAchievementResDto.gedAvgScore());
      }
      ...
      void setUp_it_throws_expected_exception() {
        ...
        given(memberService.findByIdOrThrow(memberId)).willReturn(member);
        when(oneseoService.findByMemberOrThrow(member))
            .thenThrow(
                new ExpectedException(
                    "원서를 찾을 수 없습니다. member ID: " + memberId, HttpStatus.NOT_FOUND));
      }
