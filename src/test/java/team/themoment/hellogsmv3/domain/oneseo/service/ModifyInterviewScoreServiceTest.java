...
public class ModifyInterviewScoreServiceTest {
  ...
  @InjectMocks private ModifyInterviewScoreService modifyInterviewScoreService;
  ...
  class Describe_execute {
    ...
    class Context_with_existing_member_id_and_interview_score {
      ...
      void setUp() {
        ...
        Oneseo oneseo =
            Oneseo.builder().member(member).entranceTestResult(entranceTestResult).build();
      ...
      void it_saves_interview_score() {
        ...
        ArgumentCaptor<EntranceTestResult> entranceTestResultCaptor =
            ArgumentCaptor.forClass(EntranceTestResult.class);
    ...
    class Context_with_non_existing_oneseo {
      ...
      void setUp() {
        ...
        given(memberService.findByIdOrThrow(memberId)).willReturn(member);
        given(oneseoService.findByMemberOrThrow(member))
            .willThrow(
