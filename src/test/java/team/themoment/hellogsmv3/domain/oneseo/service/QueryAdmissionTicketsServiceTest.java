...
public class QueryAdmissionTicketsServiceTest {
  ...
  @Mock private CustomOneseoRepository customOneseoRepository;

  @InjectMocks private QueryAdmissionTicketsService queryAdmissionTicketsService;
  ...
  class Describe_execute {
    AdmissionTicketsResDto firstadmissionTicketsResDto =
    ...
    AdmissionTicketsResDto secontadmissionTicketsResDto =
        AdmissionTicketsResDto.builder()
            .memberName("홍길동")
            .memberBirth(LocalDate.parse("2024-07-28"))
            .profileImg("profileImg.com")
    ...
    List<AdmissionTicketsResDto> expectedTickets =
        Arrays.asList(firstadmissionTicketsResDto, secontadmissionTicketsResDto);
