...
class CreateOneseoServiceTest {
  ...
  @InjectMocks private CreateOneseoService createOneseoService;
  ...
  class Describe_execute {
    ...
    class Context_with_invalid_member_id {
      ...
      void setUp() {
        ...
        doThrow(
            ...
            .when(memberService)
            .findByIdForUpdateOrThrow(memberId);
      }
      ...
      void it_throws_expected_exception() {
        ExpectedException exception =
            assertThrows(
                ExpectedException.class, () -> createOneseoService.execute(reqDto, memberId));
    ...
    class Context_with_invalid_achievement {
      ...
      MiddleSchoolAchievementReqDto invalidMiddleSchoolAchievementReqDto =
          mock(MiddleSchoolAchievementReqDto.class);
      ...
      void it_general_throws_expected_exception() {
        ...
        given(invalidMiddleSchoolAchievementReqDto.achievement1_2())
            .willReturn(invalidGeneralAchievements);
        given(invalidMiddleSchoolAchievementReqDto.achievement2_1())
            .willReturn(invalidGeneralAchievements);
        given(invalidMiddleSchoolAchievementReqDto.achievement2_2())
            .willReturn(invalidGeneralAchievements);
        given(invalidMiddleSchoolAchievementReqDto.achievement3_1())
            .willReturn(invalidGeneralAchievements);
        given(invalidMiddleSchoolAchievementReqDto.achievement3_2())
            .willReturn(invalidGeneralAchievements);
