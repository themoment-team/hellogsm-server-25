...
class UploadExcelServiceTest {
  ...
  @InjectMocks private UploadExcelService uploadExcelService;
  ...
  class Describe_execute {
    ...
    class Context_with_valid_mixed_cells {
      ...
      void it_saves_with_rounded_scores() throws Exception {
        ...
        EntranceTestResult r1 =
            mockEntranceResult("1001", new BigDecimal("10"), new BigDecimal("11"));
        EntranceTestResult r2 =
            mockEntranceResult("1002", new BigDecimal("20"), new BigDecimal("21"));
        ...
        when(entranceTestResultRepository.saveAll(any()))
            .thenAnswer(
                inv -> {
        ...
        // then
        ArgumentCaptor<Collection<EntranceTestResult>> captor =
  ...
  private EntranceTestResult mockEntranceResult(
      String examinationNumber, BigDecimal competency, BigDecimal interview) {
    ...
    doAnswer(
        ...
        .when(result)
        .modifyCompetencyEvaluationScore(any(BigDecimal.class));
    doAnswer(
            a -> {
        ...
        .when(result)
        .modifyInterviewScore(any(BigDecimal.class));
    return result;
  }
