...
class SearchOneseoServiceTest {
  ...
  @InjectMocks private SearchOneseoService searchOneseoService;
  ...
  class Describe_execute {
    ...
    class Context_with_no_search_results {
      ...
      void setUp() {
        ...
        given(
                oneseoRepository.findAllByKeywordAndScreeningAndSubmissionStatusAndTestResult(
      ...
      void it_returns_empty_result() {
        SearchOneseosResDto result =
            searchOneseoService.execute(
                page, size, testResultTag, screeningTag, isSubmitted, keyword);
    ...
    class Context_with_filtering {
      ...
      void setUp() {
        ...
        SearchOneseoResDto searchOneseoResDto =
            buildSearchOneseoDto(member, oneseo, oneseoPrivacyDetail, entranceTestResult);
        Page<SearchOneseoResDto> oneseoPage =
            new PageImpl<>(List.of(searchOneseoResDto), pageable, 1);
      ...
      void it_returns_filtered_results() {
        ...
        assertEquals(
            oneseoPrivacyDetail.getGuardianPhoneNumber(), searchOneseoResDto.guardianPhoneNumber());
        assertEquals(
        ...
        assertEquals(
            entranceTestResult.getCompetencyEvaluationScore(),
        ...
        assertEquals(
            entranceTestResult.getSecondTestPassYn(), searchOneseoResDto.secondTestPassYn());
      }
    }
  }
  ...
  private SearchOneseoResDto buildSearchOneseoDto(
      Member member,
      Oneseo oneseo,
