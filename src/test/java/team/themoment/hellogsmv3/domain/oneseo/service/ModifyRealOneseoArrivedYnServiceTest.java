...
public class ModifyRealOneseoArrivedYnServiceTest {
  ...
  @InjectMocks private ModifyRealOneseoArrivedYnService modifyRealOneseoArrivedYnService;
    ...
    class Context_with_existing_member_id {
      ...
      void setUp() {
        ...
        EntranceTestResult entranceTestResult =
            EntranceTestResult.builder().firstTestPassYn(null).build();
    ...
    class Context_with_non_existing_member_id {
      ...
      void it_throws_expected_exception() {
        ...
        ExpectedException exception =
            assertThrows(
                ExpectedException.class, () -> modifyRealOneseoArrivedYnService.execute(memberId));
