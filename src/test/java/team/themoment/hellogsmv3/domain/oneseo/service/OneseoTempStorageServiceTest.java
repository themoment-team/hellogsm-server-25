...
public class OneseoTempStorageServiceTest {
  ...
  @InjectMocks private OneseoTempStorageService oneseoTempStorageService;
  ...
  class Describe_execute {
    ...
    private final OneseoTempReqDto reqDto =
        OneseoTempReqDto.builder()
            // 필요한 필드를 설정
    ...
    class Context_with_existing_member_id {
      ...
      class Oneseo_not_exist {
        ...
        private void assertDto(FoundOneseoResDto resDto) {
          ...
          assertEquals(
              reqDto.relationshipWithGuardian(), resDto.privacyDetail().relationshipWithGuardian());
          ...
          assertEquals(
              reqDto.schoolTeacherPhoneNumber(), resDto.privacyDetail().schoolTeacherPhoneNumber());
          ...
          assertEquals(
              reqDto.middleSchoolAchievement().achievement1_2(),
              resDto.middleSchoolAchievement().achievement1_2());
          assertEquals(
              reqDto.middleSchoolAchievement().achievement2_1(),
              resDto.middleSchoolAchievement().achievement2_1());
          assertEquals(
              reqDto.middleSchoolAchievement().achievement2_2(),
              resDto.middleSchoolAchievement().achievement2_2());
          assertEquals(
              reqDto.middleSchoolAchievement().achievement3_1(),
              resDto.middleSchoolAchievement().achievement3_1());
          assertEquals(
              reqDto.middleSchoolAchievement().achievement3_2(),
              resDto.middleSchoolAchievement().achievement3_2());
          assertEquals(
              reqDto.middleSchoolAchievement().generalSubjects(),
              resDto.middleSchoolAchievement().generalSubjects());
          assertEquals(
              reqDto.middleSchoolAchievement().newSubjects(),
              resDto.middleSchoolAchievement().newSubjects());
          assertEquals(
              reqDto.middleSchoolAchievement().artsPhysicalAchievement(),
              resDto.middleSchoolAchievement().artsPhysicalAchievement());
          assertEquals(
              reqDto.middleSchoolAchievement().artsPhysicalSubjects(),
              resDto.middleSchoolAchievement().artsPhysicalSubjects());
          assertEquals(
              reqDto.middleSchoolAchievement().absentDays(),
              resDto.middleSchoolAchievement().absentDays());
          assertEquals(
              reqDto.middleSchoolAchievement().attendanceDays(),
              resDto.middleSchoolAchievement().attendanceDays());
          assertEquals(
              reqDto.middleSchoolAchievement().volunteerTime(),
              resDto.middleSchoolAchievement().volunteerTime());
          assertEquals(
              reqDto.middleSchoolAchievement().liberalSystem(),
              resDto.middleSchoolAchievement().liberalSystem());
          assertEquals(
              reqDto.middleSchoolAchievement().freeSemester(),
              resDto.middleSchoolAchievement().freeSemester());
          assertEquals(
              reqDto.middleSchoolAchievement().gedAvgScore(),
        ...
        given(memberService.findByIdOrThrow(memberId))
            .willThrow(
                new ExpectedException(
                    "존재하지 않는 회원입니다. member ID: " + memberId, HttpStatus.NOT_FOUND));
      }
