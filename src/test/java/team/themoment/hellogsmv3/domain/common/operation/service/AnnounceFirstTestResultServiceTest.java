...
class AnnounceFirstTestResultServiceTest {
  ...
  @InjectMocks private AnnounceFirstTestResultService announceFirstTestResultService;
    ...
    class Context_operation_test_result_not_found {
      ...
      void it_throws_expected_exception() {
        ExpectedException exception =
            assertThrows(ExpectedException.class, () -> announceFirstTestResultService.execute());
