...
class AnnounceSecondTestResultServiceTest {
  ...
  @Mock private ScheduleEnvironment scheduleEnv;

  @InjectMocks private AnnounceSecondTestResultService announceSecondTestResultService;
    ...
    class Context_operation_test_result_not_found {
      ...
      void it_throws_expected_exception() {
        ExpectedException exception =
            assertThrows(ExpectedException.class, () -> announceSecondTestResultService.execute());
