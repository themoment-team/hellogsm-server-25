...
public class UploadImageServiceTest {
  ...
  @Mock private S3Environment s3Environment;

  @InjectMocks private UploadImageService uploadImageService;
  ...
  class Describe_execute {
    ...
    class Context_with_non_existing_file {
      ...
      void it_throws_expected_exception() {
        ExpectedException exception =
            assertThrows(ExpectedException.class, () -> uploadImageService.execute(emptyFile));
    ...
    class Context_with_non_valid_extension {
      ...
      void it_throws_expected_exception() {
        ExpectedException exception =
            assertThrows(ExpectedException.class, () -> uploadImageService.execute(file));
