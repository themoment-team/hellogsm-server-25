...
public class AuthenticateCodeServiceTest {
  ...
  @InjectMocks private AuthenticateCodeService authenticateCodeService;
  ...
  class Describe_execute {
    ...
    class Context_with_existing_code_and_valid_code {
      ...
      void setUp() {
        authenticationCode =
            new AuthenticationCode(
                memberId, validCode, "01000000000", LocalDateTime.now(), SIGNUP, false);
      ...
      void it_authenticates_code_and_saves() {
        ...
        ArgumentCaptor<AuthenticationCode> codeCaptor =
