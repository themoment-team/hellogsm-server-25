...
public class QueryMySecondTestResultServiceTest {
  ...
  @InjectMocks private QueryMySecondTestResultService queryMySecondTestResultService;
  ...
  class Describe_execute {
    ...
    class Context_with_second_test_result_announced {
      ...
      void it_returns_second_test_result_and_decided_major() {
        ...
        assertEquals(
            oneseo.getEntranceTestResult().getSecondTestPassYn(), result.secondTestPassYn());
