...
class CreateMemberServiceTest {
  ...
  @Mock private ScheduleEnvironment scheduleEnvironment;
  ...
  class Describe_execute {
    ...
    private final CreateMemberReqDto reqDto =
        new CreateMemberReqDto(
            "validCode", "최장우", "01012345678", Sex.MALE, LocalDate.of(2006, 3, 6));
    ...
    class Context_with_valid_member_id_and_request_data {
      ...
      void setUp() {
        ...
        given(memberRepository.findByPhoneNumber(reqDto.phoneNumber()))
        ...
        verify(memberRepository)
            .save(
                org.mockito.ArgumentMatchers.argThat(
                    member ->
                        member.getId().equals(existingMember.getId())
                            && member.getEmail().equals(existingMember.getEmail())
                            && member
                                .getAuthReferrerType()
                                .equals(existingMember.getAuthReferrerType())
    ...
    class Context_with_invalid_member_id {
      ...
      void it_throws_expected_exception() {
        ExpectedException exception =
            assertThrows(
                ExpectedException.class, () -> createMemberService.execute(reqDto, memberId));
