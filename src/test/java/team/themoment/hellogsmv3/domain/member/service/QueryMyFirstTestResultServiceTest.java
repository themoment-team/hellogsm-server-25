...
public class QueryMyFirstTestResultServiceTest {
  ...
  @InjectMocks private QueryMyFirstTestResultService queryMyFirstTestResultService;
  ...
  class Describe_execute {
    ...
    void setUp() {
      ...
      oneseo =
          Oneseo.builder()
              .member(member)
              .entranceTestResult(EntranceTestResult.builder().firstTestPassYn(YesNo.YES).build())
              .build();
