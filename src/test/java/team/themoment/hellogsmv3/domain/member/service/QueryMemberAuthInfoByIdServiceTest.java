...
public class QueryMemberAuthInfoByIdServiceTest {
  ...
  @InjectMocks private QueryMemberAuthInfoByIdService queryMemberAuthInfoByIdService;
    ...
    class Context_with_non_existing_member_id {
      ...
      void it_throws_expected_exception() {
        ExpectedException exception =
            assertThrows(
                ExpectedException.class, () -> queryMemberAuthInfoByIdService.execute(memberId));
